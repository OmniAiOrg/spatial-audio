...
},{}],"js/face_3d_spatial_audio.js":[function(require,module,exports) {
"use strict";
...
var audioCtx;
var listener; // const indicator = document.querySelector('.indicator');
...
function init(audioElements) {
  ...
  if (true) {
    window.addEventListener('build', function (event) {
      var info = document.querySelector('.info'); // let z = event.alpha,
      //   x = event.beta,
      //   y = event.gamma;
      // // console.log(x+","+y+","+z);
      // let values = [z, x, y];
      ...
      var global_forward = event.point_forward;
      info.textContent = (0, _helper.print)(['u: x', 'y', 'z'], global_up);
      info.textContent += (0, _helper.print)(['f: x', 'y', 'z'], global_forward); // Change the position of head and recalculate the volume on each ear
      ...
      console.log('forward', global_forward); // indicator.style.left  = (-maxY*(y-90)/180 - 10) + "px";
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/face_3d_spatial_audio.js"], null)
//# sourceMappingURL=/face_3d_spatial_audio.43f427b7.js.map