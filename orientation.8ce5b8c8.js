...
var arrow_width = arrow.clientWidth; // console.log("arrow"+arrow_width);
...
function handleOrientation(event) {
  ...
  var z = event.alpha;
  output.textContent = "alpha: ".concat(Number(z).toFixed(2), "\n");
  output.textContent += "beta : ".concat(Number(x).toFixed(2), "\n");
  output.textContent += "gamma: ".concat(Number(y).toFixed(2), "\n"); // Because we don't want to have the device upside down
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/orientation.js"], null)
